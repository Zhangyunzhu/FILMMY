 ...
 void main()
{
     ...
     vec2 newTextureCoordinate = vec2((scale - 1.0) *0.2 + textureCoordinate.x / scale ,(scale - 1.0) *0.2 + textureCoordinate.y /scale);
    ...
    vec3 blendFirstColor = vec3(textureColor.r , textureColor.g, shiftColor2.b);
    
    vec3 blend3DColor = vec3(shiftColor1.r, blendFirstColor.g, blendFirstColor.b);
